...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterUncreatableType<EntryState>("Todolist.Constants", 1, 0, "EntryState",
        "This is only a container for an enumeration.");
    qmlRegisterUncreatableType<EntrySubState>("Todolist.Constants", 1, 0, "EntrySubState",
        "This is only a container for an enumeration.");
